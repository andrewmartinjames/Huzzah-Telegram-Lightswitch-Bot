...
const char ssid[] = "SSID"; //SSID of network to connect to
const char pass[] = "Password"; //password of network to connect to

const char* BotToken = "XXXXXXXXXXXXXX"; //From Telegram BotFather, used for authentication
const char* BotName = "BotName"; //Established through BotFather
const char* BotUsername = "BotUsername"; //Established through BotFather
